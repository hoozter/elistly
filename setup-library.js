  ...
  window.ELISTLY_PRESETS.library = {
    ...
    entityTypes: {
      book: {
        ...
        enableNameGen: false, nameGen: { prefix: '', partOfNamePrefix: false, suffixType: 'number', componentsOrder: [] },
        fields: [
          { name: 'title', label: 'Title', type: 'text', required: true, visibleInCard: false, partOfName: false, useAsTitle: true },
        ...
        associations: [{ name: 'lentTo', label: 'Lent to', type: 'association', association: { kind: 'belongs_to', targetType: 'borrower' } }]
      },
      borrower: {
        id: 'borrower', label: 'Borrower', category: 'borrowers', icon: 'account_circle',
        enableNameGen: false, nameGen: { prefix: '', partOfNamePrefix: false, suffixType: 'number', componentsOrder: [] },
        fields: [
          { name: 'name', label: 'Name', type: 'text', required: true, visibleInCard: false, partOfName: false, useAsTitle: true },
